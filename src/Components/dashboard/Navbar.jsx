...
import MailSetuLogo from '../../assets/Header/MailSetu_Logo.png';
...
function Navbar() {
  ...
  // ── Refs — wrap each trigger + dropdown together ──
  const notifRef  = useRef(null);   // wraps bell button + notification dropdown
  const avatarRef = useRef(null);   // wraps avatar button + profile dropdown
  ...
  useEffect(() => {
    ...
    // Only attach when at least one dropdown is open
  ...
  const handleNotifToggle = () => {
    ...
    setMenuOpen(false);           // close avatar when opening notif
    if (opening) {
  ...
  const handleAvatarToggle = () => {
    setMenuOpen(o => !o);
    setNotifOpen(false);          // close notif when opening avatar
  };
    ...
    <nav className={`navbar ${DARK_HEADER ? "navbar--dark" : "navbar--light"}`}>
      <div className="navbar-inner">
        ...
        <div className="navbar-right">
          ...
          {/* Notification bell — ref wraps button + dropdown */}
          ...
          {/* Avatar + dropdown — ref wraps button + dropdown */}
          <div className="navbar-avatar-wrap" ref={avatarRef}>
            ...
            {menuOpen && (
              <div className="navbar-dropdown">
                ...
                <button className="navbar-dropdown-item" onClick={() => { navigate("/profile"); setMenuOpen(false); }}>
                  Profile & Settings
                </button>
